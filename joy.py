...
class Transformation:
    ...
    def __add__(self, right):
        return TransformationGroup([self, right])
...
class TransformationList(Transformation):
    ...
    def __repr__(self):
        return " | ".join(repr(t) for t in self.transformations) 
...
class TransformationGroup(Transformation):
        ...
        def apply(self, shape):
            return Group([t.apply(shape) for t in self.transformations])
...
class Repeat(Transformation):
    ...
    def __repr__(self):
        return f"repeat(self.n, {self.transformation})"
